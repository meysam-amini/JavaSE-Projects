package Calendar;//--------------------- Copyright Block ----------------------
/*
...
public class PrayTime {
     ...
     * @param args
     */
    public static String[] getOghat(Date d) {
        
    	
    	
    	double latitude = TimeZon.getArz();
        double longitude = TimeZon.getTool();
        double timezone = TimeZon.getZone();
